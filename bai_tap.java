...
class Order {
    ...
    public Order(Customer customer, ArrayList<OrderLine> orderLine) {
        this.customer = customer;
        this.orderLine = orderLine;
        for (OrderLine line : orderLine) {
            total.setAmount(line.getValue().getAmount() + total.getAmount());
        }
    }
...
public class bai_tap {
    public static void main(String[] args) {
        ...
        System.out.println();
        Order new_order = new Order(customer, new ArrayList<OrderLine>());
